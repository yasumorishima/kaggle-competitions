...
- **The gap to the top is not land, and it is not care; it is what is standing on the land.** One season put side by side with the top published plan: 11–17 strawberry plants against their 36, 110 units sold against 243, in a town holding the price at $238 for both farms — three ice-cream shops and two smoothie shops, and the market not close to saturated. So the obvious hypothesis was that the third quadrant had been rejected only because it was being filled with wheat, and that land and crop had to be tested as a set. Tested as a 2×2 that is exactly backwards: raising the strawberry target alone is **+3,750 ± 3,101**, the third quadrant alone is **−6,364** (an independent reproduction of the earlier −5,741), and the two together are **−11,659**. Cutting wheat and tomato to make room destroys the strawberry gain outright, +3,750 becoming −471, because wheat here is not a cash crop but the herd's feed and the floor is computed from the herd. Raising the care weight, the other visible gap in the breakdown — 967 of their actions against 321 of ours — is **−574**, a tie. Only one of the four visible differences was a cause.
- **What was rationing the strawberries was the order the budget is spent in.** The planner hands a fixed tile budget to each product in a written sequence and whatever comes last receives the remainder. Strawberry, at $250 the dearest thing the farm can grow, was written last; tomato, at $67 and returning 29 units for $1,617 across a whole season, took its cap first. The order is now a setting rather than a line of code, and the default keeps the hand-written sequence only because every verdict recorded before this one was measured under it.
