...
| `sched_bite.py` / `test_sched_ops.py` | Whether the calendar reaches the orders at all, and whether every mutation operator fires and actually changes the calendar |
