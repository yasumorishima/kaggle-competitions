...
P.update({'animal_payback_rule': 'forward', 'dist_weight': 0.9, 'feed_buy_days': 2, 'feed_grow': 0.4, 'fert_cap': 0, 'open_crop_zero': [[0, ['TOMATO', 'STRAWBERRY']]], 'open_melon': [[0, 12]], 'sched_herd_floor': [[0, {'COW': 2, 'SHEEP': 2}], [6, {'COW': 2, 'SHEEP': 3}]], 'sched_veto': True})
