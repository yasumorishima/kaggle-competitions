...
# v57: v56 + feed_value_rule asset (feeding counts the dropping too, so the cows are not starved)
...
P.update({'animal_payback_rule': 'forward', 'dist_weight': 0.9, 'feed_buy_days': 2, 'feed_grow': 0.4, 'feed_value_rule': 'asset', 'fert_cap': 0, 'fert_sell_days': 9, 'open_crop_zero': [[5, ['TOMATO', 'STRAWBERRY', 'CARROT']]], 'open_melon': [[0, 12]], 'opening_days': 9, 'plant_last_day': {'WHEAT': 24, 'CARROT': 25, 'MELON': 11, 'TOMATO': 16, 'STRAWBERRY': 16}, 'reserve_by_item': {'FERTILIZER': 0.0}, 'sched_herd_floor': [[0, {'COW': 2, 'SHEEP': 2}], [3, {'COW': 3, 'SHEEP': 2}], [5, {'COW': 4, 'SHEEP': 2}], [6, {'COW': 5, 'SHEEP': 3}], [8, {'COW': 6, 'SHEEP': 3}]], 'sched_veto': True})
