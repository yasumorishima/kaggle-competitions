...
# --- v22: 全体最良の組で割り当て、粘りを切る ---
# seed 3600-3647 の 96 試合で 80,360 対 74,262（+6,098 +/- 2,411）。
# 粘りは名簿順の取り合いへの当て物だったので、割当が正しくなると良い割当を妨げる側に回る。
P.update({"assign_rule": "global", "stickiness": 1.0})
