...
P.update({'animal_payback_rule': 'forward', 'dist_weight': 0.9, 'feed_buy_days': 2, 'feed_grow': 0.4, 'fert_cap': 0, 'sched_herd_floor': [[0, {'SHEEP': 3}]], 'sched_veto': True})
