...
# v45 on main.py with the feed_grow knob, default off
...
P.update({'animal_payback_rule': 'forward', 'dist_weight': 0.9, 'fert_cap': 0, 'sched_herd_floor': [[0, {'SHEEP': 3}]], 'sched_veto': True})
