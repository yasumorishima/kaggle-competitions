...
# v41 = v40 (v38 calendar + dist_weight 0.9) with the payback veto on. Direct contest
# with v38 over five disjoint bands and 480 games: margin +1,266 +/- 449 pooled by
# inverse variance, positive on every band (+2,054 +694 +1,691 +1,624 +629), one
# replicate HELD. Not submitted on its own -- the ladder cannot resolve it, since a
# per-submission sample is 26 to 44 episodes with a standard error near 4,300.
...
P.update({"dist_weight": 0.9, "sched_veto": True, "animal_payback_rule": "forward"})
