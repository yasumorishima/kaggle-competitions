...
# gated_g45 + 2026-08-25 の main.py（dist 0.7 既定 + care_urgency + reserve_by_item）
...
# --- diagnostic build: route planner, to see where its actions go ---
P.update({"planner": "route"})
