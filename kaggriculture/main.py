...
# Units per tile per day, from the yield tables at full care. Real episodes
# deliver less than this (milk lands at 0.71-0.76 against the table's 1.50),
# but substituting the measured rates was swept head-to-head and lost badly:
# the herd is sized as demand/rate, so a lower rate buys more livestock, and the
# capital that goes into cattle is capital the crops never get. The table value
# acts as the conservative one here. Measured 2026-08-21, 12 games per variant.
