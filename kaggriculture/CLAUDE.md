...
- 現在の最新 2 提出＝**v67_sched（2026-09-26 3 本目・下の節）と v66_sched（2026-09-26 00:09 UTC・run `36203670737`）**。v65 以前は押し出された。
  2026-09-26 は 3 本（残り 2）。
...
0. **v67_sched を提出**（09-26 の 3 本目）。次の候補は v67 に双子で勝つもの。
