...
- 現在の最新 2 提出＝**v63_sched（2026-09-25 4 本目・下の節）と v62_sched（2026-09-25 04:17 UTC・run `36093806019`）**。v60 以前は押し出された。
  2026-09-24 は 5 本（上限）。2026-09-25 は v58・v60・v62・v63 の 4 本。
...
0. **v63_sched を提出**（2026-09-25 の 4 本目）。最新 2 本＝v63 と v62。次の候補は v63 に双子で勝つもの。
   h10s は router で BETTER（+3,950）・双子 tie＝router 寄りの候補として v63 上で引き直す価値あり。
