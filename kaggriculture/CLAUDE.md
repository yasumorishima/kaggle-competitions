...
- 現在の最新 2 提出＝**v64_sched（2026-09-25 07:07 UTC・run `36106020839`）と v63_sched（2026-09-25 05:59 UTC・run `36100768348`）**。v62 以前は押し出された。
...
0. **09-26：v65_sched を提出（1 本目）→ 続けて v66_sched（2 本目）**（証拠は上の 2 節・v66 は v65 に勝つ）。
