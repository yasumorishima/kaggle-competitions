...
- 現在の最新 2 提出＝**v68_sched（2026-09-26 4 本目・下の節）と v67_sched（2026-09-26 02:29 UTC・run `36211786181`）**。v66 以前は押し出された。
  2026-09-26 は 4 本（残り 1）。
...
0. **v68_sched を提出**（09-26 の 4 本目）。次の候補は v68 に双子で勝つもの。
