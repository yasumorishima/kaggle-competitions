...
- 現在の最新 2 提出＝**v55_sched（2026-09-24 提出・下の節）と v53_sched（2026-09-24 09:17 UTC・run `35980271383`）**。v51・v48 は押し出された。
  2026-09-24 の提出は v51・v53・v55 の 3 本（1 日 5 本まで）。
...
0. **v55_sched を提出**（2026-09-24・双子 v53 に BETTER＋HELD・router tie）。v53_sched は提出済み（run `35980271383`）。
   次は v55 を base（再生成して v56）に、双子の相手を v55 にして掃く。候補：ml11 と組む植え付け終期（トマト 21・イチゴ 19 を前へ）・`fert_sell_days` の再掃引。
