...
- 現在の最新 2 提出＝**v53_sched（2026-09-24 09:17 UTC・run `35980271383`）と v51_sched（2026-09-24 06:40・run `35965521829`）**。v48 は押し出された。
...
0. ✅ **v53_sched は提出済み**（2026-09-24・PR #10 → submit run `35980271383` success・一覧で PENDING を確認）。最新 2 本＝v53 と v51。
   次のセッションで v53 の publicScore を読む（参考のみ）。
