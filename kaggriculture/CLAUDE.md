...
- 現在の最新 2 提出＝**v58_sched（2026-09-25 提出・下の節）と v57_sched（2026-09-24 14:59 UTC・run `36016650793`）**。v56 以前は押し出された。
  2026-09-24 は 5 本（上限）。2026-09-25 は v58 が 1 本目。
...
0. **v58_sched を提出**（2026-09-25 の 1 本目）。最新 2 本＝v58 と v57。次の候補は v58 に双子で勝つもの。
