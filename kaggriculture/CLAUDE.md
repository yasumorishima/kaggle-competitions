...
- 現在の最新 2 提出＝**v66_sched（2026-09-26 00:09 UTC・run `36203670737`）と v65_sched（2026-09-26 00:07 UTC・run `36203579366`）**。v64 以前は押し出された。
  2026-09-26 は 2 本（残り 3）。
...
0. ✅ 09-26：v65・v66 を提出済み。次の候補は v66 に双子で勝つもの。
