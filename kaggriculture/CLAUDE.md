...
- 現在の最新 2 提出＝**v56_sched（2026-09-24 提出・下の節）と v55_sched（2026-09-24 11:29 UTC・run `35993213493`）**。v53 以前は押し出された。
  2026-09-24 の提出は v51・v53・v55・v56 の 4 本（1 日 5 本まで）。
...
0. **v56_sched を提出**（2026-09-24・双子 v55 に BETTER＋HELD・router tie）。v55_sched は提出済み（run `35993213493`）。
   次は v56 を base に双子の相手を v56 にして掃く。候補：イチゴ・トマトの終期 14〜18 の細かい位置、`dump_day`、`fert_sell_days` の再掃引、whst（router で BETTER）との差。
