...
- 現在の最新 2 提出＝**v56_sched（2026-09-24 12:47 UTC・run `36001128031`）と v55_sched（2026-09-24 11:29 UTC・run `35993213493`）**。v53 以前は押し出された。
  2026-09-24 の提出は v51・v53・v55・v56 の 4 本（5 本目は勝つ候補が無く出していない）。
...
0. ✅ **v56_sched は提出済み**（run `36001128031`・12:47 UTC）。最新 2 本＝v56 と v55。次のセッションで両者の publicScore を読む（参考のみ）。
   次の候補は v56 に双子で勝つもの。ノブの微調整は第 7・8 回で尽きた＝`diag/traj.py` で v56 と router の差（日程の形）を見て、構造の手を 1 つ作ってから掃く。
